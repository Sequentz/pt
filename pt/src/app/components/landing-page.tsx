...
const LandingPage = () => {
  return (
    ...
    <div>
      <main>
        {/* Hero Section */}
        <section className="bg-cover bg-center h-80 sm:h-96 text-white text-center flex items-center justify-center" >
          <div>

            <h1 className="text-3xl sm:text-5xl font-bold">Channel The Violence</h1>
            <p className="mt-2 sm:mt-4 text-lg sm:text-xl">Get ripped or die trying</p>
          </div>
        </section>

        {/* Services Section */}
        <section id="services" className="py-16 bg-black text-center">
          <h2 className="text-3xl sm:text-4xl font-bold text-gray-100 mb-8">Aanbod</h2>
